...
AHP$InstabSum <- ifelse(AHP$InstabSum > 0.596000000, 0.596000000, AHP$InstabSum)
AHP$AguaTotal <- ifelse(AHP$AguaTotal > 0.233000000, 0.233000000, AHP$AguaTotal)
AHP$VegTotal <- ifelse(AHP$VegTotal > 0.037398979, 0.037398979, AHP$VegTotal)
